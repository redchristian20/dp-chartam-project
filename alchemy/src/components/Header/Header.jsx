    ...
    <div>
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
            <a href="#" className="flex items-center space-x-5 rtl:space-x-reverse">
                <img src={Logo} className="h-24 dark:invert" alt="Alchemy Logo" />
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Alchemy</span>
            </a>
